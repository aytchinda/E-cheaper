        ...
        <div class="col-md-8">
            <form
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Email_verified_at ..." name="email_verified_at"
                        value="{{ old('email_verified_at', isset($user) ? $user->email_verified_at : '') }}"
                        class="form-control" id="email_verified_at" aria-describedby="email_verified_atHelp" required />

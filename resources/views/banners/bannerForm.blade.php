    ...
    <div class="row">
        <div class="col-md-8">
            <form
                action="{{ isset($banner) ? route('admin.banner.update', ['banner' => $banner->id]) : route('admin.banner.store') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Title ..." name="title"
                        value="{{ old('title', isset($banner) ? $banner->title : '') }}" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="Description ..." name="description"
                        value="{{ old('description', isset($banner) ? $banner->description : '') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="ButtonText ..." name="buttonText"
                        value="{{ old('buttonText', isset($banner) ? $banner->buttonText : '') }}" class="form-control"
                        id="buttonText" aria-describedby="buttonTextHelp" required />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" placeholder="ButtonLink ..." name="buttonLink"
                        value="{{ old('buttonLink', isset($banner) ? $banner->buttonLink : '') }}" class="form-control"
                        id="buttonLink" aria-describedby="buttonLinkHelp" required />
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="imageUrl"
                        value="{{ old('imageUrl', isset($banner) ? $banner->imageUrl : '') }}"

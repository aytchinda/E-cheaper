...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('admin.shopcollection.create') }}" class="btn btn-success m-1">

            Create Shopcollection
...
<div class="">
    ...
    <div class="table-responsive">
        <table  id="Shopcollection" class="table">
            <thead>
                <tr>
                    <th scope="col">N#</th>
            ...
            <tbody>
                @foreach($shopcollections as $shopcollection)
						...
						<td>
                    <a href="{{ route('admin.shopcollection.show', ['id' => $shopcollection->id]) }}" class="btn btn-primary btn-sm">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                    <a href="{{ route('admin.shopcollection.edit', ['id' => $shopcollection->id]) }}" class="btn btn-success btn-sm">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <a href="#" data-id="{{ $shopcollection->id }}" class="btn btn-danger btn-sm deleteBtn">
        ...
        <div class="d-flex justify-content-center">
            {{ $shopcollections->links('pagination::bootstrap-5') }}
        </div>
    </div>
</div>
</div>
...
@section('scripts')
    ...
    <script>
        ...
        checkbox.onchange = async (event) => {
            ...
            const response = await fetch('/admin/shopcollections/speed/' + id, {
                method: 'PUT',
        ...
        deleteButtons.forEach(deleteButton => {
            deleteButton.addEventListener('click', (event)=>{
                ...
                confirmDeleteBtn.addEventListener('click',async ()=>{
                    const csrfToken = document.head.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('/admin/shopcollections/delete/'+id , {
                        method: 'DELETE',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': csrfToken
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const tableHeaders = document.querySelectorAll('#Shopcollection th');
            ...
            tableHeaders.forEach(function(header, index) {
                ...
                const savedSelection = localStorage.getItem('selectedColumns#Shopcollection');
        ...
        function toggleColumn(columnIndex, show) {
            const dataTable = document.getElementById('Shopcollection');
        ...
        function saveSelection() {
            ...
            localStorage.setItem('selectedColumns#Shopcollection', JSON.stringify(selectedColumns));
        }
        ...
        function sortTable(columnIndex) {
            const table = document.getElementById('Shopcollection');
